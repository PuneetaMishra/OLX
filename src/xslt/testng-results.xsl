...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="testNgXslt.drivertype"/>
        ...
        <xsl:result-document href="{testng:absolutePath('overview.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                    ...
                    BrowserType  =
                    <xsl:choose>
                    <xsl:when test="contains($testNgXslt.drivertype,'{drivertype}')">
                    FF18
                    </xsl:when>
                    <xsl:otherwise>
                    <xsl:value-of select="$testNgXslt.drivertype" />
                    </xsl:otherwise>
                    </xsl:choose>
                    <br/>
                ...
                <td nowrap="true" width="50px">
                    <xsl:if test="./exception">
                        <a onclick="toggleDetailsVisibility('{$exceptionDetailsId}')">
                            <xsl:value-of select="exception/@class"/>:: <b><xsl:value-of select="exception/message"/></b>
                        </a>
                    </xsl:if>
                    &#160;
                </td>
